<template>
    <div class="main">
        <Header title="北京高端团"></Header>
        <div class="jpg">
            <img src="../../../assets/home3003.jpg" alt="ad1" id="ad1">
        </div>
        <div class="jpg">
            <img src="../../../assets/home3004.jpg" alt="ad1" id="ad1">
        </div>
        <div class="jpg">
            <img src="../../../assets/home3005.jpg" alt="ad1" id="ad1">
        </div>
        <div class="store">
            <van-action-bar>

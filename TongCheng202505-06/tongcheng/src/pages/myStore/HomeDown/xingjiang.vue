<template>
    <div class="main">
        <Header title="来‘北疆’撒野"></Header>
        <div class="jpg">
            <img src="../../../assets/home3031.jpg" alt="ad1" id="ad1">
        </div>
                <div class="jpg">
            <img src="../../../assets/home3032.jpg" alt="ad1" id="ad1">
        </div>
                <div class="jpg">
            <img src="../../../assets/home3033.jpg" alt="ad1" id="ad1">
        </div>
        <div class="store">
            <van-action-bar>

<template>
    <div class="main">
        <Header title="四川九寨沟"></Header>
        <div class="jpg">
            <img src="../../../assets/home3013.jpg" alt="ad1" id="ad1">
        </div>
        <div class="jpg">
            <img src="../../../assets/home3014.jpg" alt="ad1" id="ad1">
        </div>
        <div class="jpg">
            <img src="../../../assets/home3015.jpg" alt="ad1" id="ad1">
        </div>
        <div class="store">
            <van-action-bar>

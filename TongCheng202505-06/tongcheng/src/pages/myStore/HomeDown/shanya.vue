<template>
    <div class="main">
        <Header title="亚特兰蒂斯"></Header>
        <div class="jpg">
            <img src="../../../assets/home3020.jpg" alt="ad1" id="ad1">
        </div>
        <div class="jpg">
            <img src="../../../assets/home3021.jpg" alt="ad1" id="ad1">
        </div>
        <div class="jpg">
            <img src="../../../assets/home3022.jpg" alt="ad1" id="ad1">
        </div>
        <div class="store">
            <van-action-bar>
